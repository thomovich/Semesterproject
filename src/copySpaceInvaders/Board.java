...
public class Board extends JPanel {
	...
	private void drawQuestion(Graphics g) {
		g.setColor(Color.green);
		g.fillOval(50, Commons.ALIEN_WIDTH/2-30,Commons.BOARD_WIDTH-100 , 50);
	...
	private void update() {
		...
		for (Alien alien : aliens) {
			...
			if (x >= Commons.BOARD_WIDTH - Commons.BORDER_RIGHT && direction != -1) {//går over treshold til højre på skærmen
